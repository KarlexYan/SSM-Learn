...
public class CodeGenerator {
    public static void main(String[] args) {
        ...
        globalConfig.setOutputDir(System.getProperty("user.dir")+"/MyBatisPlus-Generator/src/main/java");    //设置代码生成位置
        globalConfig.setOpen(false);    //设置生成完毕后是否打开生成代码所在的目录
        globalConfig.setAuthor("KarlexYan");    //设置作者
        ...
        packageInfo.setParent("com.karlexyan");   //设置生成的包名，与代码所在位置不冲突，二者叠加组成完整路径
